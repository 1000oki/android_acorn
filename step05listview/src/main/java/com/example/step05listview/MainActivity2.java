...
public class MainActivity2 extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // new ArrayAdaper<>(Context, layout resource, 모델)
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        // int i는 클릭한 아이템의 인덱스가 들어 있다.
        Toast.makeText(this,this.names.get(i), Toast.LENGTH_SHORT).show();
    }

    // DialogInterface.OnClickListener type 필드드
   DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
    ...
    public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l){
        ...
        // 위 필드에 값을 넣어줄 때 사용한 익명 클래스에서 참조 가능하도록 필드에 담아둔다.
        selectedIndex = i;
