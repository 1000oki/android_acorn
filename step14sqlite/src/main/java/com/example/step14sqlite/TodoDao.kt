...
/*
    TodoDao 클래스의 대표 생성자(primary constructor)의 인자로 DBHelper 객체를 전달받아서
    ...
    java의 JDBC에서 PreparedStatement 객체와 비슷한 기능을 하는 객체가 SQLiteDataBase객체이다.
 */
    ...
    fun getList():List<Todo>{
        ...
        */
        ...
        while (result.moveToNext()){
            // 0 번째는 num, 1 번째는 content, 2 번째는 regdate이다.
