...
public class MyFragment extends Fragment implements View.OnClickListener {
    ...
    // layout 으로 사용할 View를 만들어서 리턴해 주어야한다.
    @Nullable
    @Override
    ...
    public void onClick(View v) {
        ...
        /*
            만일 count 값이 10의 배수이면 이 fragment를 제어하고 있는 액티비티에 해당 정보를 알려보자!
        ...
        // 혹시 액티비티가 MyFragmentListener 인터페이스를 구현하지 않았을 수도 잇기 때문에 type을 확인해서 casting
