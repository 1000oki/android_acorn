...
public class PlaceholderFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        // PageView 모델이 가지고 있는 데이터를 관찰하고 있다가 혹시 변경이 되면 UI를 업데이트할 옵져버 등록
        // 단, 이 뷰의 주인(프래그먼트 혹은 액티비티)가 활성화된 상태에서만 동작하겠다는 의미미
       ...
       binding.changeBtn.setOnClickListener(view->{
           ...
           // PageViewModel이 가지고 있는 라이브 데이터를 업데이트 한다.
