...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendClicked(View v){
        ...
        // 사용자를 방해하지 않고, 잠시 떴다가 사라지는 토스트메세지
        Toast.makeText(this, "전송 버튼을 눌럿네?", Toast.LENGTH_SHORT).show();
    }
    /*
        Delete 버튼을 하나 원하는 위치에 배치하고
        해당 버튼을 눌렀을 때 "삭제 버튼을 눌렀네?"라는 토스트 메세지가 출력되도록 해 보세요.
     */
    public void deleteClicked(View v){
        Toast.makeText(this, "삭제버튼을 눌렀네?", Toast.LENGTH_SHORT).show();
    }
}