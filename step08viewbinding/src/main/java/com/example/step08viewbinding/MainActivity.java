...
/*
    ...
    예를 들어 activity_main.xml 문서이면 ActivityMainBinding 클래스
    예를 들어 actiivty_sub.xml 문서이면 ActivitySubBinding클래스...
 */
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        //setContentView(R.layout.activity_main); // 바인딩을 사용할 때는 이렇게 사용하지 않는다.
...
//        TextView textView = binding.textView;
        ...
        /*
            ...
            TextView로 이동하도록프로그래밍 한다면 아래와 같은 코딩이 된다.
         */
